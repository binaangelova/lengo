    ...
    <div className="bg-blue-100 min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex flex-col items-center pt-16">
        <div className="text-center p-4">
          <h1 className="text-5xl font-bold mb-4 text-blue-900">Добавяне на урок</h1>
          <p className="text-xl text-blue-800">Тук можете да добавите нов урок към платформата.</p>
        </div>
